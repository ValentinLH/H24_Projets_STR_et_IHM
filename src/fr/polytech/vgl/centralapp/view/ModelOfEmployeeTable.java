...
public class ModelOfEmployeeTable extends AbstractTableModel {
	...
	/**
	 * Permet de r�cup�rer le nombre de colonne
	 */
	...
	/**
	 * Permet de r�cup�rer le nombre de ligne
	 */
	...
	/**
	 * Permet de cr�er le tableau de tous les employ�s et de stocker les valeurs au
	...
	/**
	 * Permet de r�cuperer le nom des colonnes
	 */
	 ...
	 * 
	 * @param la position de la ligne � supprimer
	 */
	...
	/**
	 * Permet de modifier une ligne. La m�thode n'est pas utilis�e car nous n'avaons
	 * pas eu le temps
	 * 
	 * @param selection
	 * @param name
