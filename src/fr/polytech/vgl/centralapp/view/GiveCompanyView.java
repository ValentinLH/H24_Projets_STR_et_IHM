...
public class GiveCompanyView extends JFrame {
	...
	/**
	 * Menu d�roulant qui va comprendre le nom des diff�rentes entreprises
	 */
	...
	/*
	 * Permet de cr�er la premi�re fen�tre comportant le menu d�roulant des
	...
	/**
	 * permet de r�cup�rer le menu d�roulant
	 * 
	 * @return le menu d�roulant
	 */
	...
	/**
	 * C'est le corps de la fen�tre Il y a la cr�ation du menu d�roulant et de ses
	 * actions et la cr�ation du bouton "Done" qui permet de confirmer le choix On
	...
	/**
	 * Permet d'ajouter une entreprise dans un menu d�roulant
	 * 
	...
	/**
	 * Permet d'avoir la liste des entreprises dans le menu d�roulant
	 * 
