...
public class TimeExecutionTest {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Temps de traitement de l'app central pour 100 pointages: " + executionTime + " nanoseconds");
		System.out.println("Le temps moyen de traitement de l'app central pour 1 pointage est de : " + moyenne / 100
				+ " nanoseconds");

		System.out.println(
				"Temps de traitement de l'app central pour 100 pointages: " + executionTimeList + " nanoseconds");
