...
public class Record implements Comparable<Record>, java.io.Serializable {
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(this.record.getHour(), other.record.getHour())
				&& Objects.equals(this.employee, other.employee)
				&& Objects.equals(this.record.getMinute(), other.record.getMinute())
				&& Objects.equals(this.record.toLocalDate(), other.record.toLocalDate());
	}
